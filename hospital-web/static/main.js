...
var PatientService = /** @class */ (function () {
    ...
    PatientService.prototype.deletePatient = function (patient) {
        return this.http.post(this.patientUrl + '/' + 'deleteAll', patient, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(3), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
...
var PatientListComponent = /** @class */ (function () {
    ...
    PatientListComponent.prototype.submit = function () {
        ...
        if (this.onDelete) {
            // this.doDelete();
            this.patientService.deletePatient(this.selected()).subscribe(function (model) {
                _this.refreshList();
                console.log(model);
            });
        }
...
module.exports = __webpack_require__(/*! C:\Users\Joe\Desktop\eclipse\workspaces\hospitalbootangular\hospital-interface\src\main.ts */"./src/main.ts");
